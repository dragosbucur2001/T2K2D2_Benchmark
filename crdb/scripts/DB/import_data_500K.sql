...
import into genders (id, type) csv data
	('nodelocal://1/500K/documents_clean500K.json.db.genders.csv');

import into authors (id, id_gender, age) csv data
	('nodelocal://1/500K/documents_clean500K.json.db.authors.csv');
...
import into documents_authors (
	id_document,
	id_author
) csv data ('nodelocal://1/500K/documents_clean500K.json.db.documents_authors.csv');
...
import into vocabulary (
	...
	count,
	tf
) csv data ('nodelocal://1/500K/documents_clean500K.json.db.vocabulary.csv');
