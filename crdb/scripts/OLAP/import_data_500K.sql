...
import into word_dimension (id_word, word) csv data
	('nodelocal://1/500K/documents_clean500K.json.olap.words.csv');
...
import into document_dimension (
	...
	clean_text,
	raw_text
) csv data ('nodelocal://1/500K/documents_clean500K.json.olap.documents.csv');

import into time_dimension (id_time, full_date) csv data
	('nodelocal://1/500K/documents_clean500K.json.olap.date.csv');
